...
const Header = () => {
    const list = ['Women','Divided','Men','Baby','Kids','H&M','HOME','Sport','Sale','지속가능성']
        ...
        <div>
            ...
            <div className="menuGnb">
                ...
                <div className="search">
                    ...
                    <input type="text" placeholder='제품검색' onKeyUp={Search}/>
                </div>
            </div>
        </div>
    )
